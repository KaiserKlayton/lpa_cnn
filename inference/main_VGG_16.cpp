...
int main() 
{
	...
	const int im_num = 1;
	MatrixXd train = load_csv_arma<MatrixXd>("../inputs/VGG_16/production/VGG_16.csv");
    ...
    {   
		...
		std::tie(conv4_1, gemm_time_8, offline_time_8) = convolve(pool3, im_size_8, im_height_8, im_width_8, im_depth_8, k_size_8, stride_8, conv4_1_b, p1_8, p2_8, conv4_1_w, output_size_8);
		...
		std::tie(conv4_2, gemm_time_9, offline_time_9) = convolve(relu4_1, im_size_9, im_height_9, im_width_9, im_depth_9, k_size_9, stride_9, conv4_2_b, p1_9, p2_9, conv4_2_w, output_size_9);
		...
		std::tie(conv4_3, gemm_time_10, offline_time_10) = convolve(relu4_2, im_size_10, im_height_10, im_width_10, im_depth_10, k_size_10, stride_10, conv4_3_b, p1_10, p2_10, conv4_3_w, output_size_10);
		...
		std::tie(conv5_1, gemm_time_11, offline_time_11) = convolve(pool4, im_size_11, im_height_11, im_width_11, im_depth_11, k_size_11, stride_11, conv5_1_b, p1_11, p2_11, conv5_1_w, output_size_11);
		...
		std::tie(conv5_2, gemm_time_12, offline_time_12) = convolve(relu5_1, im_size_12, im_height_12, im_width_12, im_depth_12, k_size_12, stride_12, conv5_2_b, p1_12, p2_12, conv5_2_w, output_size_12);
		...
		std::tie(conv5_3, gemm_time_13, offline_time_13) = convolve(relu5_2, im_size_13, im_height_13, im_width_13, im_depth_13, k_size_13, stride_13, conv5_3_b, p1_13, p2_13, conv5_3_w, output_size_13);
		...
		std::string name_1 = "../features/VGG_16/conv1_1_" + std::to_string(i) + ".csv";
		write_to_csv(name_1, conv1_1);
		std::string name_2 = "../features/VGG_16/relu1_1_" + std::to_string(i) + ".csv";
		write_to_csv(name_2, relu1_1);
		std::string name_3 = "../features/VGG_16/conv1_2_" + std::to_string(i) + ".csv";
		write_to_csv(name_3, conv1_2);
		std::string name_4 = "../features/VGG_16/relu1_2_" + std::to_string(i) + ".csv";
		write_to_csv(name_4, relu1_2);
		std::string name_5 = "../features/VGG_16/pool1_" + std::to_string(i) + ".csv";
		write_to_csv(name_5, pool1);
		std::string name_6 = "../features/VGG_16/conv2_1_" + std::to_string(i) + ".csv";
		write_to_csv(name_6, conv2_1);
		std::string name_7 = "../features/VGG_16/relu2_1_" + std::to_string(i) + ".csv";
		write_to_csv(name_7, relu2_1);
		std::string name_8 = "../features/VGG_16/conv2_2_" + std::to_string(i) + ".csv";
		write_to_csv(name_8, conv2_2);
		std::string name_9 = "../features/VGG_16/relu2_2_" + std::to_string(i) + ".csv";
		write_to_csv(name_9, relu2_2);
		std::string name_10 = "../features/VGG_16/pool2_" + std::to_string(i) + ".csv";
		write_to_csv(name_10, pool2);
		std::string name_11 = "../features/VGG_16/conv3_1_" + std::to_string(i) + ".csv";
		write_to_csv(name_11, conv3_1);
		std::string name_12 = "../features/VGG_16/relu3_1_" + std::to_string(i) + ".csv";
		write_to_csv(name_12, relu3_1);
		std::string name_13 = "../features/VGG_16/conv3_2_" + std::to_string(i) + ".csv";
		write_to_csv(name_13, conv3_2);
		std::string name_14 = "../features/VGG_16/relu3_2_" + std::to_string(i) + ".csv";
		write_to_csv(name_14, relu3_2);
		std::string name_15 = "../features/VGG_16/conv3_3_" + std::to_string(i) + ".csv";
		write_to_csv(name_15, conv3_3);
		std::string name_16 = "../features/VGG_16/relu3_3_" + std::to_string(i) + ".csv";
		write_to_csv(name_16, relu3_3);
		std::string name_17 = "../features/VGG_16/pool3_" + std::to_string(i) + ".csv";
		write_to_csv(name_17, pool3);
		std::string name_18 = "../features/VGG_16/conv4_1_" + std::to_string(i) + ".csv";
		write_to_csv(name_18, conv4_1);
		std::string name_19 = "../features/VGG_16/relu4_1_" + std::to_string(i) + ".csv";
		write_to_csv(name_19, relu4_1);
		std::string name_20 = "../features/VGG_16/conv4_2_" + std::to_string(i) + ".csv";
		write_to_csv(name_20, conv4_2);
		std::string name_21 = "../features/VGG_16/relu4_2_" + std::to_string(i) + ".csv";
		write_to_csv(name_21, relu4_2);
		std::string name_22 = "../features/VGG_16/conv4_3_" + std::to_string(i) + ".csv";
		write_to_csv(name_22, conv4_3);
		std::string name_23 = "../features/VGG_16/relu4_3_" + std::to_string(i) + ".csv";
		write_to_csv(name_23, relu4_3);
		std::string name_24 = "../features/VGG_16/pool4_" + std::to_string(i) + ".csv";
		write_to_csv(name_24, pool4);
		std::string name_25 = "../features/VGG_16/conv5_1_" + std::to_string(i) + ".csv";
		write_to_csv(name_25, conv5_1);
		std::string name_26 = "../features/VGG_16/relu5_1_" + std::to_string(i) + ".csv";
		write_to_csv(name_26, relu5_1);
		std::string name_27 = "../features/VGG_16/conv5_2_" + std::to_string(i) + ".csv";
		write_to_csv(name_27, conv5_2);
		std::string name_28 = "../features/VGG_16/relu5_2_" + std::to_string(i) + ".csv";
		write_to_csv(name_28, relu5_2);
		std::string name_29 = "../features/VGG_16/conv5_3_" + std::to_string(i) + ".csv";
		write_to_csv(name_29, conv5_3);
		std::string name_30 = "../features/VGG_16/relu5_3_" + std::to_string(i) + ".csv";
		write_to_csv(name_30, relu5_3);
		std::string name_31 = "../features/VGG_16/pool5_" + std::to_string(i) + ".csv";
		write_to_csv(name_31, pool5);
		std::string name_32 = "../features/VGG_16/fc6_" + std::to_string(i) + ".csv";
		write_to_csv(name_32, fc6);
		std::string name_33 = "../features/VGG_16/relu6_" + std::to_string(i) + ".csv";
		write_to_csv(name_33, relu6);
		std::string name_34 = "../features/VGG_16/fc7_" + std::to_string(i) + ".csv";
		write_to_csv(name_34, fc7);
		std::string name_35 = "../features/VGG_16/relu7_" + std::to_string(i) + ".csv";
		write_to_csv(name_35, relu7);
		std::string name_36 = "../features/VGG_16/fc8_" + std::to_string(i) + ".csv";
		write_to_csv(name_36, fc8);
    }
