...
int main() 
{
	...
	const int im_num = 1;
	MatrixXd train = load_csv_arma<MatrixXd>("../inputs/ResNet101/production/ResNet101.csv");
    ...
    {   
		...
		std::tie(res2a_branch1, gemm_time_2, offline_time_2) = convolve(pool1, im_size_2, im_height_2, im_width_2, im_depth_2, k_size_2, stride_2, res2a_branch1_b, p1_2, p2_2, res2a_branch1_w, output_size_2);
		
		MatrixXd res2a_branch2a;
		double gemm_time_3;
		double offline_time_3;
		std::tie(res2a_branch2a, gemm_time_3, offline_time_3) = convolve(pool1, im_size_3, im_height_3, im_width_3, im_depth_3, k_size_3, stride_3, res2a_branch2a_b, p1_3, p2_3, res2a_branch2a_w, output_size_3);
		...
		std::tie(res2a_branch2b, gemm_time_4, offline_time_4) = convolve(res2a_branch2a_relu, im_size_4, im_height_4, im_width_4, im_depth_4, k_size_4, stride_4, res2a_branch2b_b, p1_4, p2_4, res2a_branch2b_w, output_size_4);
		...
		std::tie(res2a_branch2c, gemm_time_5, offline_time_5) = convolve(res2a_branch2b_relu, im_size_5, im_height_5, im_width_5, im_depth_5, k_size_5, stride_5, res2a_branch2c_b, p1_5, p2_5, res2a_branch2c_w, output_size_5);
		...
		std::tie(res2b_branch2a, gemm_time_6, offline_time_6) = convolve(res2a_relu, im_size_6, im_height_6, im_width_6, im_depth_6, k_size_6, stride_6, res2b_branch2a_b, p1_6, p2_6, res2b_branch2a_w, output_size_6);
		...
		std::tie(res2b_branch2b, gemm_time_7, offline_time_7) = convolve(res2b_branch2a_relu, im_size_7, im_height_7, im_width_7, im_depth_7, k_size_7, stride_7, res2b_branch2b_b, p1_7, p2_7, res2b_branch2b_w, output_size_7);
		...
		std::tie(res2b_branch2c, gemm_time_8, offline_time_8) = convolve(res2b_branch2b_relu, im_size_8, im_height_8, im_width_8, im_depth_8, k_size_8, stride_8, res2b_branch2c_b, p1_8, p2_8, res2b_branch2c_w, output_size_8);
		...
		std::tie(res2c_branch2a, gemm_time_9, offline_time_9) = convolve(res2b_relu, im_size_9, im_height_9, im_width_9, im_depth_9, k_size_9, stride_9, res2c_branch2a_b, p1_9, p2_9, res2c_branch2a_w, output_size_9);
		...
		std::tie(res2c_branch2b, gemm_time_10, offline_time_10) = convolve(res2c_branch2a_relu, im_size_10, im_height_10, im_width_10, im_depth_10, k_size_10, stride_10, res2c_branch2b_b, p1_10, p2_10, res2c_branch2b_w, output_size_10);
		...
		std::tie(res2c_branch2c, gemm_time_11, offline_time_11) = convolve(res2c_branch2b_relu, im_size_11, im_height_11, im_width_11, im_depth_11, k_size_11, stride_11, res2c_branch2c_b, p1_11, p2_11, res2c_branch2c_w, output_size_11);
		...
		std::tie(res3a_branch1, gemm_time_12, offline_time_12) = convolve(res2c_relu, im_size_12, im_height_12, im_width_12, im_depth_12, k_size_12, stride_12, res3a_branch1_b, p1_12, p2_12, res3a_branch1_w, output_size_12);
		
		MatrixXd res3a_branch2a;
		double gemm_time_13;
		double offline_time_13;
		std::tie(res3a_branch2a, gemm_time_13, offline_time_13) = convolve(res2c_relu, im_size_13, im_height_13, im_width_13, im_depth_13, k_size_13, stride_13, res3a_branch2a_b, p1_13, p2_13, res3a_branch2a_w, output_size_13);
		...
		std::tie(res3a_branch2b, gemm_time_14, offline_time_14) = convolve(res3a_branch2a_relu, im_size_14, im_height_14, im_width_14, im_depth_14, k_size_14, stride_14, res3a_branch2b_b, p1_14, p2_14, res3a_branch2b_w, output_size_14);
		...
		std::tie(res3a_branch2c, gemm_time_15, offline_time_15) = convolve(res3a_branch2b_relu, im_size_15, im_height_15, im_width_15, im_depth_15, k_size_15, stride_15, res3a_branch2c_b, p1_15, p2_15, res3a_branch2c_w, output_size_15);
		...
		std::tie(res3b1_branch2a, gemm_time_16, offline_time_16) = convolve(res3a_relu, im_size_16, im_height_16, im_width_16, im_depth_16, k_size_16, stride_16, res3b1_branch2a_b, p1_16, p2_16, res3b1_branch2a_w, output_size_16);
		...
		std::tie(res3b1_branch2b, gemm_time_17, offline_time_17) = convolve(res3b1_branch2a_relu, im_size_17, im_height_17, im_width_17, im_depth_17, k_size_17, stride_17, res3b1_branch2b_b, p1_17, p2_17, res3b1_branch2b_w, output_size_17);
		...
		std::tie(res3b1_branch2c, gemm_time_18, offline_time_18) = convolve(res3b1_branch2b_relu, im_size_18, im_height_18, im_width_18, im_depth_18, k_size_18, stride_18, res3b1_branch2c_b, p1_18, p2_18, res3b1_branch2c_w, output_size_18);
		...
		std::tie(res3b2_branch2a, gemm_time_19, offline_time_19) = convolve(res3b1_relu, im_size_19, im_height_19, im_width_19, im_depth_19, k_size_19, stride_19, res3b2_branch2a_b, p1_19, p2_19, res3b2_branch2a_w, output_size_19);
		...
		std::tie(res3b2_branch2b, gemm_time_20, offline_time_20) = convolve(res3b2_branch2a_relu, im_size_20, im_height_20, im_width_20, im_depth_20, k_size_20, stride_20, res3b2_branch2b_b, p1_20, p2_20, res3b2_branch2b_w, output_size_20);
		...
		std::tie(res3b3_branch2a, gemm_time_22, offline_time_22) = convolve(res3b2_relu, im_size_22, im_height_22, im_width_22, im_depth_22, k_size_22, stride_22, res3b3_branch2a_b, p1_22, p2_22, res3b3_branch2a_w, output_size_22);
		...
		std::tie(res3b3_branch2b, gemm_time_23, offline_time_23) = convolve(res3b3_branch2a_relu, im_size_23, im_height_23, im_width_23, im_depth_23, k_size_23, stride_23, res3b3_branch2b_b, p1_23, p2_23, res3b3_branch2b_w, output_size_23);
		...
		std::tie(res3b3_branch2c, gemm_time_24, offline_time_24) = convolve(res3b3_branch2b_relu, im_size_24, im_height_24, im_width_24, im_depth_24, k_size_24, stride_24, res3b3_branch2c_b, p1_24, p2_24, res3b3_branch2c_w, output_size_24);
		...
		std::tie(res4a_branch2a, gemm_time_26, offline_time_26) = convolve(res3b3_relu, im_size_26, im_height_26, im_width_26, im_depth_26, k_size_26, stride_26, res4a_branch2a_b, p1_26, p2_26, res4a_branch2a_w, output_size_26);
		...
		std::tie(res4a_branch2b, gemm_time_27, offline_time_27) = convolve(res4a_branch2a_relu, im_size_27, im_height_27, im_width_27, im_depth_27, k_size_27, stride_27, res4a_branch2b_b, p1_27, p2_27, res4a_branch2b_w, output_size_27);
		...
		std::tie(res4a_branch2c, gemm_time_28, offline_time_28) = convolve(res4a_branch2b_relu, im_size_28, im_height_28, im_width_28, im_depth_28, k_size_28, stride_28, res4a_branch2c_b, p1_28, p2_28, res4a_branch2c_w, output_size_28);
		...
		std::tie(res4b1_branch2a, gemm_time_29, offline_time_29) = convolve(res4a_relu, im_size_29, im_height_29, im_width_29, im_depth_29, k_size_29, stride_29, res4b1_branch2a_b, p1_29, p2_29, res4b1_branch2a_w, output_size_29);
		...
		std::tie(res4b1_branch2b, gemm_time_30, offline_time_30) = convolve(res4b1_branch2a_relu, im_size_30, im_height_30, im_width_30, im_depth_30, k_size_30, stride_30, res4b1_branch2b_b, p1_30, p2_30, res4b1_branch2b_w, output_size_30);
		...
		std::tie(res4b1_branch2c, gemm_time_31, offline_time_31) = convolve(res4b1_branch2b_relu, im_size_31, im_height_31, im_width_31, im_depth_31, k_size_31, stride_31, res4b1_branch2c_b, p1_31, p2_31, res4b1_branch2c_w, output_size_31);
		...
		std::tie(res4b2_branch2a, gemm_time_32, offline_time_32) = convolve(res4b1_relu, im_size_32, im_height_32, im_width_32, im_depth_32, k_size_32, stride_32, res4b2_branch2a_b, p1_32, p2_32, res4b2_branch2a_w, output_size_32);
		...
		std::tie(res4b2_branch2b, gemm_time_33, offline_time_33) = convolve(res4b2_branch2a_relu, im_size_33, im_height_33, im_width_33, im_depth_33, k_size_33, stride_33, res4b2_branch2b_b, p1_33, p2_33, res4b2_branch2b_w, output_size_33);
		...
		std::tie(res4b2_branch2c, gemm_time_34, offline_time_34) = convolve(res4b2_branch2b_relu, im_size_34, im_height_34, im_width_34, im_depth_34, k_size_34, stride_34, res4b2_branch2c_b, p1_34, p2_34, res4b2_branch2c_w, output_size_34);
		...
		std::tie(res4b3_branch2a, gemm_time_35, offline_time_35) = convolve(res4b2_relu, im_size_35, im_height_35, im_width_35, im_depth_35, k_size_35, stride_35, res4b3_branch2a_b, p1_35, p2_35, res4b3_branch2a_w, output_size_35);
		...
		std::tie(res4b3_branch2b, gemm_time_36, offline_time_36) = convolve(res4b3_branch2a_relu, im_size_36, im_height_36, im_width_36, im_depth_36, k_size_36, stride_36, res4b3_branch2b_b, p1_36, p2_36, res4b3_branch2b_w, output_size_36);
		...
		std::tie(res4b3_branch2c, gemm_time_37, offline_time_37) = convolve(res4b3_branch2b_relu, im_size_37, im_height_37, im_width_37, im_depth_37, k_size_37, stride_37, res4b3_branch2c_b, p1_37, p2_37, res4b3_branch2c_w, output_size_37);
		...
		std::tie(res4b4_branch2a, gemm_time_38, offline_time_38) = convolve(res4b3_relu, im_size_38, im_height_38, im_width_38, im_depth_38, k_size_38, stride_38, res4b4_branch2a_b, p1_38, p2_38, res4b4_branch2a_w, output_size_38);
		...
		std::tie(res4b4_branch2b, gemm_time_39, offline_time_39) = convolve(res4b4_branch2a_relu, im_size_39, im_height_39, im_width_39, im_depth_39, k_size_39, stride_39, res4b4_branch2b_b, p1_39, p2_39, res4b4_branch2b_w, output_size_39);
		...
		std::tie(res4b4_branch2c, gemm_time_40, offline_time_40) = convolve(res4b4_branch2b_relu, im_size_40, im_height_40, im_width_40, im_depth_40, k_size_40, stride_40, res4b4_branch2c_b, p1_40, p2_40, res4b4_branch2c_w, output_size_40);
		...
		std::tie(res4b5_branch2a, gemm_time_41, offline_time_41) = convolve(res4b4_relu, im_size_41, im_height_41, im_width_41, im_depth_41, k_size_41, stride_41, res4b5_branch2a_b, p1_41, p2_41, res4b5_branch2a_w, output_size_41);
		...
		std::tie(res4b5_branch2b, gemm_time_42, offline_time_42) = convolve(res4b5_branch2a_relu, im_size_42, im_height_42, im_width_42, im_depth_42, k_size_42, stride_42, res4b5_branch2b_b, p1_42, p2_42, res4b5_branch2b_w, output_size_42);
		...
		std::tie(res4b5_branch2c, gemm_time_43, offline_time_43) = convolve(res4b5_branch2b_relu, im_size_43, im_height_43, im_width_43, im_depth_43, k_size_43, stride_43, res4b5_branch2c_b, p1_43, p2_43, res4b5_branch2c_w, output_size_43);
		...
		std::tie(res4b6_branch2a, gemm_time_44, offline_time_44) = convolve(res4b5_relu, im_size_44, im_height_44, im_width_44, im_depth_44, k_size_44, stride_44, res4b6_branch2a_b, p1_44, p2_44, res4b6_branch2a_w, output_size_44);
		...
		std::tie(res4b6_branch2b, gemm_time_45, offline_time_45) = convolve(res4b6_branch2a_relu, im_size_45, im_height_45, im_width_45, im_depth_45, k_size_45, stride_45, res4b6_branch2b_b, p1_45, p2_45, res4b6_branch2b_w, output_size_45);
		...
		std::tie(res4b6_branch2c, gemm_time_46, offline_time_46) = convolve(res4b6_branch2b_relu, im_size_46, im_height_46, im_width_46, im_depth_46, k_size_46, stride_46, res4b6_branch2c_b, p1_46, p2_46, res4b6_branch2c_w, output_size_46);
		...
		std::tie(res4b7_branch2a, gemm_time_47, offline_time_47) = convolve(res4b6_relu, im_size_47, im_height_47, im_width_47, im_depth_47, k_size_47, stride_47, res4b7_branch2a_b, p1_47, p2_47, res4b7_branch2a_w, output_size_47);
		...
		std::tie(res4b7_branch2b, gemm_time_48, offline_time_48) = convolve(res4b7_branch2a_relu, im_size_48, im_height_48, im_width_48, im_depth_48, k_size_48, stride_48, res4b7_branch2b_b, p1_48, p2_48, res4b7_branch2b_w, output_size_48);
		...
		std::tie(res4b7_branch2c, gemm_time_49, offline_time_49) = convolve(res4b7_branch2b_relu, im_size_49, im_height_49, im_width_49, im_depth_49, k_size_49, stride_49, res4b7_branch2c_b, p1_49, p2_49, res4b7_branch2c_w, output_size_49);
		...
		std::tie(res4b8_branch2b, gemm_time_51, offline_time_51) = convolve(res4b8_branch2a_relu, im_size_51, im_height_51, im_width_51, im_depth_51, k_size_51, stride_51, res4b8_branch2b_b, p1_51, p2_51, res4b8_branch2b_w, output_size_51);
		...
		std::tie(res4b8_branch2c, gemm_time_52, offline_time_52) = convolve(res4b8_branch2b_relu, im_size_52, im_height_52, im_width_52, im_depth_52, k_size_52, stride_52, res4b8_branch2c_b, p1_52, p2_52, res4b8_branch2c_w, output_size_52);
		...
		std::tie(res4b9_branch2a, gemm_time_53, offline_time_53) = convolve(res4b8_relu, im_size_53, im_height_53, im_width_53, im_depth_53, k_size_53, stride_53, res4b9_branch2a_b, p1_53, p2_53, res4b9_branch2a_w, output_size_53);
		...
		std::tie(res4b9_branch2b, gemm_time_54, offline_time_54) = convolve(res4b9_branch2a_relu, im_size_54, im_height_54, im_width_54, im_depth_54, k_size_54, stride_54, res4b9_branch2b_b, p1_54, p2_54, res4b9_branch2b_w, output_size_54);
		...
		std::tie(res4b9_branch2c, gemm_time_55, offline_time_55) = convolve(res4b9_branch2b_relu, im_size_55, im_height_55, im_width_55, im_depth_55, k_size_55, stride_55, res4b9_branch2c_b, p1_55, p2_55, res4b9_branch2c_w, output_size_55);
		...
		std::tie(res4b10_branch2a, gemm_time_56, offline_time_56) = convolve(res4b9_relu, im_size_56, im_height_56, im_width_56, im_depth_56, k_size_56, stride_56, res4b10_branch2a_b, p1_56, p2_56, res4b10_branch2a_w, output_size_56);
		...
		std::tie(res4b10_branch2b, gemm_time_57, offline_time_57) = convolve(res4b10_branch2a_relu, im_size_57, im_height_57, im_width_57, im_depth_57, k_size_57, stride_57, res4b10_branch2b_b, p1_57, p2_57, res4b10_branch2b_w, output_size_57);
		...
		std::tie(res4b10_branch2c, gemm_time_58, offline_time_58) = convolve(res4b10_branch2b_relu, im_size_58, im_height_58, im_width_58, im_depth_58, k_size_58, stride_58, res4b10_branch2c_b, p1_58, p2_58, res4b10_branch2c_w, output_size_58);
		...
		std::tie(res4b11_branch2a, gemm_time_59, offline_time_59) = convolve(res4b10_relu, im_size_59, im_height_59, im_width_59, im_depth_59, k_size_59, stride_59, res4b11_branch2a_b, p1_59, p2_59, res4b11_branch2a_w, output_size_59);
		...
		std::tie(res4b11_branch2b, gemm_time_60, offline_time_60) = convolve(res4b11_branch2a_relu, im_size_60, im_height_60, im_width_60, im_depth_60, k_size_60, stride_60, res4b11_branch2b_b, p1_60, p2_60, res4b11_branch2b_w, output_size_60);
		...
		std::tie(res4b12_branch2a, gemm_time_62, offline_time_62) = convolve(res4b11_relu, im_size_62, im_height_62, im_width_62, im_depth_62, k_size_62, stride_62, res4b12_branch2a_b, p1_62, p2_62, res4b12_branch2a_w, output_size_62);
		...
		std::tie(res4b12_branch2b, gemm_time_63, offline_time_63) = convolve(res4b12_branch2a_relu, im_size_63, im_height_63, im_width_63, im_depth_63, k_size_63, stride_63, res4b12_branch2b_b, p1_63, p2_63, res4b12_branch2b_w, output_size_63);
		...
		std::tie(res4b12_branch2c, gemm_time_64, offline_time_64) = convolve(res4b12_branch2b_relu, im_size_64, im_height_64, im_width_64, im_depth_64, k_size_64, stride_64, res4b12_branch2c_b, p1_64, p2_64, res4b12_branch2c_w, output_size_64);
		...
		std::tie(res4b13_branch2a, gemm_time_65, offline_time_65) = convolve(res4b12_relu, im_size_65, im_height_65, im_width_65, im_depth_65, k_size_65, stride_65, res4b13_branch2a_b, p1_65, p2_65, res4b13_branch2a_w, output_size_65);
		...
		std::tie(res4b13_branch2b, gemm_time_66, offline_time_66) = convolve(res4b13_branch2a_relu, im_size_66, im_height_66, im_width_66, im_depth_66, k_size_66, stride_66, res4b13_branch2b_b, p1_66, p2_66, res4b13_branch2b_w, output_size_66);
		...
		std::tie(res4b13_branch2c, gemm_time_67, offline_time_67) = convolve(res4b13_branch2b_relu, im_size_67, im_height_67, im_width_67, im_depth_67, k_size_67, stride_67, res4b13_branch2c_b, p1_67, p2_67, res4b13_branch2c_w, output_size_67);
		...
		std::tie(res4b14_branch2a, gemm_time_68, offline_time_68) = convolve(res4b13_relu, im_size_68, im_height_68, im_width_68, im_depth_68, k_size_68, stride_68, res4b14_branch2a_b, p1_68, p2_68, res4b14_branch2a_w, output_size_68);
		...
		std::tie(res4b14_branch2b, gemm_time_69, offline_time_69) = convolve(res4b14_branch2a_relu, im_size_69, im_height_69, im_width_69, im_depth_69, k_size_69, stride_69, res4b14_branch2b_b, p1_69, p2_69, res4b14_branch2b_w, output_size_69);
		...
		std::tie(res4b14_branch2c, gemm_time_70, offline_time_70) = convolve(res4b14_branch2b_relu, im_size_70, im_height_70, im_width_70, im_depth_70, k_size_70, stride_70, res4b14_branch2c_b, p1_70, p2_70, res4b14_branch2c_w, output_size_70);
		...
		std::tie(res4b15_branch2a, gemm_time_71, offline_time_71) = convolve(res4b14_relu, im_size_71, im_height_71, im_width_71, im_depth_71, k_size_71, stride_71, res4b15_branch2a_b, p1_71, p2_71, res4b15_branch2a_w, output_size_71);
		...
		std::tie(res4b15_branch2b, gemm_time_72, offline_time_72) = convolve(res4b15_branch2a_relu, im_size_72, im_height_72, im_width_72, im_depth_72, k_size_72, stride_72, res4b15_branch2b_b, p1_72, p2_72, res4b15_branch2b_w, output_size_72);
		...
		std::tie(res4b15_branch2c, gemm_time_73, offline_time_73) = convolve(res4b15_branch2b_relu, im_size_73, im_height_73, im_width_73, im_depth_73, k_size_73, stride_73, res4b15_branch2c_b, p1_73, p2_73, res4b15_branch2c_w, output_size_73);
		...
		std::tie(res4b16_branch2a, gemm_time_74, offline_time_74) = convolve(res4b15_relu, im_size_74, im_height_74, im_width_74, im_depth_74, k_size_74, stride_74, res4b16_branch2a_b, p1_74, p2_74, res4b16_branch2a_w, output_size_74);
		...
		std::tie(res4b16_branch2b, gemm_time_75, offline_time_75) = convolve(res4b16_branch2a_relu, im_size_75, im_height_75, im_width_75, im_depth_75, k_size_75, stride_75, res4b16_branch2b_b, p1_75, p2_75, res4b16_branch2b_w, output_size_75);
		...
		std::tie(res4b16_branch2c, gemm_time_76, offline_time_76) = convolve(res4b16_branch2b_relu, im_size_76, im_height_76, im_width_76, im_depth_76, k_size_76, stride_76, res4b16_branch2c_b, p1_76, p2_76, res4b16_branch2c_w, output_size_76);
		...
		std::tie(res4b17_branch2a, gemm_time_77, offline_time_77) = convolve(res4b16_relu, im_size_77, im_height_77, im_width_77, im_depth_77, k_size_77, stride_77, res4b17_branch2a_b, p1_77, p2_77, res4b17_branch2a_w, output_size_77);
		...
		std::tie(res4b17_branch2b, gemm_time_78, offline_time_78) = convolve(res4b17_branch2a_relu, im_size_78, im_height_78, im_width_78, im_depth_78, k_size_78, stride_78, res4b17_branch2b_b, p1_78, p2_78, res4b17_branch2b_w, output_size_78);
		...
		std::tie(res4b18_branch2c, gemm_time_82, offline_time_82) = convolve(res4b18_branch2b_relu, im_size_82, im_height_82, im_width_82, im_depth_82, k_size_82, stride_82, res4b18_branch2c_b, p1_82, p2_82, res4b18_branch2c_w, output_size_82);
		...
		std::tie(res4b19_branch2a, gemm_time_83, offline_time_83) = convolve(res4b18_relu, im_size_83, im_height_83, im_width_83, im_depth_83, k_size_83, stride_83, res4b19_branch2a_b, p1_83, p2_83, res4b19_branch2a_w, output_size_83);
		...
		std::tie(res4b19_branch2b, gemm_time_84, offline_time_84) = convolve(res4b19_branch2a_relu, im_size_84, im_height_84, im_width_84, im_depth_84, k_size_84, stride_84, res4b19_branch2b_b, p1_84, p2_84, res4b19_branch2b_w, output_size_84);
		...
		std::tie(res4b19_branch2c, gemm_time_85, offline_time_85) = convolve(res4b19_branch2b_relu, im_size_85, im_height_85, im_width_85, im_depth_85, k_size_85, stride_85, res4b19_branch2c_b, p1_85, p2_85, res4b19_branch2c_w, output_size_85);
		...
		std::tie(res4b20_branch2a, gemm_time_86, offline_time_86) = convolve(res4b19_relu, im_size_86, im_height_86, im_width_86, im_depth_86, k_size_86, stride_86, res4b20_branch2a_b, p1_86, p2_86, res4b20_branch2a_w, output_size_86);
		...
		std::tie(res4b20_branch2b, gemm_time_87, offline_time_87) = convolve(res4b20_branch2a_relu, im_size_87, im_height_87, im_width_87, im_depth_87, k_size_87, stride_87, res4b20_branch2b_b, p1_87, p2_87, res4b20_branch2b_w, output_size_87);
		...
		std::tie(res4b20_branch2c, gemm_time_88, offline_time_88) = convolve(res4b20_branch2b_relu, im_size_88, im_height_88, im_width_88, im_depth_88, k_size_88, stride_88, res4b20_branch2c_b, p1_88, p2_88, res4b20_branch2c_w, output_size_88);
		...
		std::tie(res4b21_branch2a, gemm_time_89, offline_time_89) = convolve(res4b20_relu, im_size_89, im_height_89, im_width_89, im_depth_89, k_size_89, stride_89, res4b21_branch2a_b, p1_89, p2_89, res4b21_branch2a_w, output_size_89);
		...
		std::tie(res4b21_branch2b, gemm_time_90, offline_time_90) = convolve(res4b21_branch2a_relu, im_size_90, im_height_90, im_width_90, im_depth_90, k_size_90, stride_90, res4b21_branch2b_b, p1_90, p2_90, res4b21_branch2b_w, output_size_90);
		...
		std::tie(res4b21_branch2c, gemm_time_91, offline_time_91) = convolve(res4b21_branch2b_relu, im_size_91, im_height_91, im_width_91, im_depth_91, k_size_91, stride_91, res4b21_branch2c_b, p1_91, p2_91, res4b21_branch2c_w, output_size_91);
		...
		std::tie(res4b22_branch2a, gemm_time_92, offline_time_92) = convolve(res4b21_relu, im_size_92, im_height_92, im_width_92, im_depth_92, k_size_92, stride_92, res4b22_branch2a_b, p1_92, p2_92, res4b22_branch2a_w, output_size_92);
		...
		std::tie(res4b22_branch2b, gemm_time_93, offline_time_93) = convolve(res4b22_branch2a_relu, im_size_93, im_height_93, im_width_93, im_depth_93, k_size_93, stride_93, res4b22_branch2b_b, p1_93, p2_93, res4b22_branch2b_w, output_size_93);
		...
		std::tie(res4b22_branch2c, gemm_time_94, offline_time_94) = convolve(res4b22_branch2b_relu, im_size_94, im_height_94, im_width_94, im_depth_94, k_size_94, stride_94, res4b22_branch2c_b, p1_94, p2_94, res4b22_branch2c_w, output_size_94);
		...
		std::tie(res5a_branch1, gemm_time_95, offline_time_95) = convolve(res4b22_relu, im_size_95, im_height_95, im_width_95, im_depth_95, k_size_95, stride_95, res5a_branch1_b, p1_95, p2_95, res5a_branch1_w, output_size_95);
		...
		std::tie(res5a_branch2b, gemm_time_97, offline_time_97) = convolve(res5a_branch2a_relu, im_size_97, im_height_97, im_width_97, im_depth_97, k_size_97, stride_97, res5a_branch2b_b, p1_97, p2_97, res5a_branch2b_w, output_size_97);
		...
		std::tie(res5a_branch2c, gemm_time_98, offline_time_98) = convolve(res5a_branch2b_relu, im_size_98, im_height_98, im_width_98, im_depth_98, k_size_98, stride_98, res5a_branch2c_b, p1_98, p2_98, res5a_branch2c_w, output_size_98);
		...
		std::tie(res5b_branch2a, gemm_time_99, offline_time_99) = convolve(res5a_relu, im_size_99, im_height_99, im_width_99, im_depth_99, k_size_99, stride_99, res5b_branch2a_b, p1_99, p2_99, res5b_branch2a_w, output_size_99);
		...
		std::tie(res5b_branch2b, gemm_time_100, offline_time_100) = convolve(res5b_branch2a_relu, im_size_100, im_height_100, im_width_100, im_depth_100, k_size_100, stride_100, res5b_branch2b_b, p1_100, p2_100, res5b_branch2b_w, output_size_100);
		...
		std::tie(res5b_branch2c, gemm_time_101, offline_time_101) = convolve(res5b_branch2b_relu, im_size_101, im_height_101, im_width_101, im_depth_101, k_size_101, stride_101, res5b_branch2c_b, p1_101, p2_101, res5b_branch2c_w, output_size_101);
		...
		std::tie(res5c_branch2a, gemm_time_102, offline_time_102) = convolve(res5b_relu, im_size_102, im_height_102, im_width_102, im_depth_102, k_size_102, stride_102, res5c_branch2a_b, p1_102, p2_102, res5c_branch2a_w, output_size_102);
		...
		std::tie(res5c_branch2b, gemm_time_103, offline_time_103) = convolve(res5c_branch2a_relu, im_size_103, im_height_103, im_width_103, im_depth_103, k_size_103, stride_103, res5c_branch2b_b, p1_103, p2_103, res5c_branch2b_w, output_size_103);
		...
		std::tie(res5c_branch2c, gemm_time_104, offline_time_104) = convolve(res5c_branch2b_relu, im_size_104, im_height_104, im_width_104, im_depth_104, k_size_104, stride_104, res5c_branch2c_b, p1_104, p2_104, res5c_branch2c_w, output_size_104);
		
		MatrixXd res5c = eltwise(res5c_branch2c, res5b_relu);
		
		MatrixXd res5c_relu = relu(res5c);
		
		MatrixXd pool5 = pool(res5c_relu, f_2, s_2, output_width_104, output_height_104, pp1_2, pp2_2);
		...
		std::string name_1 = "../features/ResNet101/conv1_" + std::to_string(i) + ".csv";
		write_to_csv(name_1, conv1);
		std::string name_2 = "../features/ResNet101/conv1_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_2, conv1_relu);
		std::string name_3 = "../features/ResNet101/pool1_" + std::to_string(i) + ".csv";
		write_to_csv(name_3, pool1);
		std::string name_4 = "../features/ResNet101/res2a_branch1_" + std::to_string(i) + ".csv";
		write_to_csv(name_4, res2a_branch1);
		std::string name_5 = "../features/ResNet101/res2a_branch2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_5, res2a_branch2a);
		std::string name_6 = "../features/ResNet101/res2a_branch2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_6, res2a_branch2a_relu);
		std::string name_7 = "../features/ResNet101/res2a_branch2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_7, res2a_branch2b);
		std::string name_8 = "../features/ResNet101/res2a_branch2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_8, res2a_branch2b_relu);
		std::string name_9 = "../features/ResNet101/res2a_branch2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_9, res2a_branch2c);
		std::string name_10 = "../features/ResNet101/res2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_10, res2a);
		std::string name_11 = "../features/ResNet101/res2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_11, res2a_relu);
		std::string name_12 = "../features/ResNet101/res2b_branch2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_12, res2b_branch2a);
		std::string name_13 = "../features/ResNet101/res2b_branch2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_13, res2b_branch2a_relu);
		std::string name_14 = "../features/ResNet101/res2b_branch2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_14, res2b_branch2b);
		std::string name_15 = "../features/ResNet101/res2b_branch2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_15, res2b_branch2b_relu);
		std::string name_16 = "../features/ResNet101/res2b_branch2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_16, res2b_branch2c);
		std::string name_17 = "../features/ResNet101/res2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_17, res2b);
		std::string name_18 = "../features/ResNet101/res2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_18, res2b_relu);
		std::string name_19 = "../features/ResNet101/res2c_branch2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_19, res2c_branch2a);
		std::string name_20 = "../features/ResNet101/res2c_branch2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_20, res2c_branch2a_relu);
		std::string name_21 = "../features/ResNet101/res2c_branch2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_21, res2c_branch2b);
		std::string name_22 = "../features/ResNet101/res2c_branch2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_22, res2c_branch2b_relu);
		std::string name_23 = "../features/ResNet101/res2c_branch2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_23, res2c_branch2c);
		std::string name_24 = "../features/ResNet101/res2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_24, res2c);
		std::string name_25 = "../features/ResNet101/res2c_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_25, res2c_relu);
		std::string name_26 = "../features/ResNet101/res3a_branch1_" + std::to_string(i) + ".csv";
		write_to_csv(name_26, res3a_branch1);
		std::string name_27 = "../features/ResNet101/res3a_branch2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_27, res3a_branch2a);
		std::string name_28 = "../features/ResNet101/res3a_branch2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_28, res3a_branch2a_relu);
		std::string name_29 = "../features/ResNet101/res3a_branch2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_29, res3a_branch2b);
		std::string name_30 = "../features/ResNet101/res3a_branch2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_30, res3a_branch2b_relu);
		std::string name_31 = "../features/ResNet101/res3a_branch2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_31, res3a_branch2c);
		std::string name_32 = "../features/ResNet101/res3a_" + std::to_string(i) + ".csv";
		write_to_csv(name_32, res3a);
		std::string name_33 = "../features/ResNet101/res3a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_33, res3a_relu);
		std::string name_34 = "../features/ResNet101/res3b1_branch2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_34, res3b1_branch2a);
		std::string name_35 = "../features/ResNet101/res3b1_branch2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_35, res3b1_branch2a_relu);
		std::string name_36 = "../features/ResNet101/res3b1_branch2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_36, res3b1_branch2b);
		std::string name_37 = "../features/ResNet101/res3b1_branch2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_37, res3b1_branch2b_relu);
		std::string name_38 = "../features/ResNet101/res3b1_branch2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_38, res3b1_branch2c);
		std::string name_39 = "../features/ResNet101/res3b1_" + std::to_string(i) + ".csv";
		write_to_csv(name_39, res3b1);
		std::string name_40 = "../features/ResNet101/res3b1_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_40, res3b1_relu);
		std::string name_41 = "../features/ResNet101/res3b2_branch2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_41, res3b2_branch2a);
		std::string name_42 = "../features/ResNet101/res3b2_branch2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_42, res3b2_branch2a_relu);
		std::string name_43 = "../features/ResNet101/res3b2_branch2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_43, res3b2_branch2b);
		std::string name_44 = "../features/ResNet101/res3b2_branch2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_44, res3b2_branch2b_relu);
		std::string name_45 = "../features/ResNet101/res3b2_branch2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_45, res3b2_branch2c);
		std::string name_46 = "../features/ResNet101/res3b2_" + std::to_string(i) + ".csv";
		write_to_csv(name_46, res3b2);
		std::string name_47 = "../features/ResNet101/res3b2_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_47, res3b2_relu);
		std::string name_48 = "../features/ResNet101/res3b3_branch2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_48, res3b3_branch2a);
		std::string name_49 = "../features/ResNet101/res3b3_branch2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_49, res3b3_branch2a_relu);
		std::string name_50 = "../features/ResNet101/res3b3_branch2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_50, res3b3_branch2b);
		std::string name_51 = "../features/ResNet101/res3b3_branch2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_51, res3b3_branch2b_relu);
		std::string name_52 = "../features/ResNet101/res3b3_branch2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_52, res3b3_branch2c);
		std::string name_53 = "../features/ResNet101/res3b3_" + std::to_string(i) + ".csv";
		write_to_csv(name_53, res3b3);
		std::string name_54 = "../features/ResNet101/res3b3_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_54, res3b3_relu);
		std::string name_55 = "../features/ResNet101/res4a_branch1_" + std::to_string(i) + ".csv";
		write_to_csv(name_55, res4a_branch1);
		std::string name_56 = "../features/ResNet101/res4a_branch2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_56, res4a_branch2a);
		std::string name_57 = "../features/ResNet101/res4a_branch2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_57, res4a_branch2a_relu);
		std::string name_58 = "../features/ResNet101/res4a_branch2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_58, res4a_branch2b);
		std::string name_59 = "../features/ResNet101/res4a_branch2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_59, res4a_branch2b_relu);
		std::string name_60 = "../features/ResNet101/res4a_branch2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_60, res4a_branch2c);
		std::string name_61 = "../features/ResNet101/res4a_" + std::to_string(i) + ".csv";
		write_to_csv(name_61, res4a);
		std::string name_62 = "../features/ResNet101/res4a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_62, res4a_relu);
		std::string name_63 = "../features/ResNet101/res4b1_branch2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_63, res4b1_branch2a);
		std::string name_64 = "../features/ResNet101/res4b1_branch2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_64, res4b1_branch2a_relu);
		std::string name_65 = "../features/ResNet101/res4b1_branch2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_65, res4b1_branch2b);
		std::string name_66 = "../features/ResNet101/res4b1_branch2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_66, res4b1_branch2b_relu);
		std::string name_67 = "../features/ResNet101/res4b1_branch2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_67, res4b1_branch2c);
		std::string name_68 = "../features/ResNet101/res4b1_" + std::to_string(i) + ".csv";
		write_to_csv(name_68, res4b1);
		std::string name_69 = "../features/ResNet101/res4b1_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_69, res4b1_relu);
		std::string name_70 = "../features/ResNet101/res4b2_branch2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_70, res4b2_branch2a);
		std::string name_71 = "../features/ResNet101/res4b2_branch2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_71, res4b2_branch2a_relu);
		std::string name_72 = "../features/ResNet101/res4b2_branch2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_72, res4b2_branch2b);
		std::string name_73 = "../features/ResNet101/res4b2_branch2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_73, res4b2_branch2b_relu);
		std::string name_74 = "../features/ResNet101/res4b2_branch2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_74, res4b2_branch2c);
		std::string name_75 = "../features/ResNet101/res4b2_" + std::to_string(i) + ".csv";
		write_to_csv(name_75, res4b2);
		std::string name_76 = "../features/ResNet101/res4b2_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_76, res4b2_relu);
		std::string name_77 = "../features/ResNet101/res4b3_branch2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_77, res4b3_branch2a);
		std::string name_78 = "../features/ResNet101/res4b3_branch2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_78, res4b3_branch2a_relu);
		std::string name_79 = "../features/ResNet101/res4b3_branch2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_79, res4b3_branch2b);
		std::string name_80 = "../features/ResNet101/res4b3_branch2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_80, res4b3_branch2b_relu);
		std::string name_81 = "../features/ResNet101/res4b3_branch2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_81, res4b3_branch2c);
		std::string name_82 = "../features/ResNet101/res4b3_" + std::to_string(i) + ".csv";
		write_to_csv(name_82, res4b3);
		std::string name_83 = "../features/ResNet101/res4b3_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_83, res4b3_relu);
		std::string name_84 = "../features/ResNet101/res4b4_branch2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_84, res4b4_branch2a);
		std::string name_85 = "../features/ResNet101/res4b4_branch2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_85, res4b4_branch2a_relu);
		std::string name_86 = "../features/ResNet101/res4b4_branch2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_86, res4b4_branch2b);
		std::string name_87 = "../features/ResNet101/res4b4_branch2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_87, res4b4_branch2b_relu);
		std::string name_88 = "../features/ResNet101/res4b4_branch2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_88, res4b4_branch2c);
		std::string name_89 = "../features/ResNet101/res4b4_" + std::to_string(i) + ".csv";
		write_to_csv(name_89, res4b4);
		std::string name_90 = "../features/ResNet101/res4b4_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_90, res4b4_relu);
		std::string name_91 = "../features/ResNet101/res4b5_branch2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_91, res4b5_branch2a);
		std::string name_92 = "../features/ResNet101/res4b5_branch2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_92, res4b5_branch2a_relu);
		std::string name_93 = "../features/ResNet101/res4b5_branch2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_93, res4b5_branch2b);
		std::string name_94 = "../features/ResNet101/res4b5_branch2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_94, res4b5_branch2b_relu);
		std::string name_95 = "../features/ResNet101/res4b5_branch2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_95, res4b5_branch2c);
		std::string name_96 = "../features/ResNet101/res4b5_" + std::to_string(i) + ".csv";
		write_to_csv(name_96, res4b5);
		std::string name_97 = "../features/ResNet101/res4b5_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_97, res4b5_relu);
		std::string name_98 = "../features/ResNet101/res4b6_branch2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_98, res4b6_branch2a);
		std::string name_99 = "../features/ResNet101/res4b6_branch2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_99, res4b6_branch2a_relu);
		std::string name_100 = "../features/ResNet101/res4b6_branch2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_100, res4b6_branch2b);
		std::string name_101 = "../features/ResNet101/res4b6_branch2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_101, res4b6_branch2b_relu);
		std::string name_102 = "../features/ResNet101/res4b6_branch2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_102, res4b6_branch2c);
		std::string name_103 = "../features/ResNet101/res4b6_" + std::to_string(i) + ".csv";
		write_to_csv(name_103, res4b6);
		std::string name_104 = "../features/ResNet101/res4b6_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_104, res4b6_relu);
		std::string name_105 = "../features/ResNet101/res4b7_branch2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_105, res4b7_branch2a);
		std::string name_106 = "../features/ResNet101/res4b7_branch2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_106, res4b7_branch2a_relu);
		std::string name_107 = "../features/ResNet101/res4b7_branch2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_107, res4b7_branch2b);
		std::string name_108 = "../features/ResNet101/res4b7_branch2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_108, res4b7_branch2b_relu);
		std::string name_109 = "../features/ResNet101/res4b7_branch2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_109, res4b7_branch2c);
		std::string name_110 = "../features/ResNet101/res4b7_" + std::to_string(i) + ".csv";
		write_to_csv(name_110, res4b7);
		std::string name_111 = "../features/ResNet101/res4b7_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_111, res4b7_relu);
		std::string name_112 = "../features/ResNet101/res4b8_branch2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_112, res4b8_branch2a);
		std::string name_113 = "../features/ResNet101/res4b8_branch2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_113, res4b8_branch2a_relu);
		std::string name_114 = "../features/ResNet101/res4b8_branch2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_114, res4b8_branch2b);
		std::string name_115 = "../features/ResNet101/res4b8_branch2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_115, res4b8_branch2b_relu);
		std::string name_116 = "../features/ResNet101/res4b8_branch2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_116, res4b8_branch2c);
		std::string name_117 = "../features/ResNet101/res4b8_" + std::to_string(i) + ".csv";
		write_to_csv(name_117, res4b8);
		std::string name_118 = "../features/ResNet101/res4b8_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_118, res4b8_relu);
		std::string name_119 = "../features/ResNet101/res4b9_branch2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_119, res4b9_branch2a);
		std::string name_120 = "../features/ResNet101/res4b9_branch2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_120, res4b9_branch2a_relu);
		std::string name_121 = "../features/ResNet101/res4b9_branch2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_121, res4b9_branch2b);
		std::string name_122 = "../features/ResNet101/res4b9_branch2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_122, res4b9_branch2b_relu);
		std::string name_123 = "../features/ResNet101/res4b9_branch2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_123, res4b9_branch2c);
		std::string name_124 = "../features/ResNet101/res4b9_" + std::to_string(i) + ".csv";
		write_to_csv(name_124, res4b9);
		std::string name_125 = "../features/ResNet101/res4b9_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_125, res4b9_relu);
		std::string name_126 = "../features/ResNet101/res4b10_branch2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_126, res4b10_branch2a);
		std::string name_127 = "../features/ResNet101/res4b10_branch2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_127, res4b10_branch2a_relu);
		std::string name_128 = "../features/ResNet101/res4b10_branch2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_128, res4b10_branch2b);
		std::string name_129 = "../features/ResNet101/res4b10_branch2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_129, res4b10_branch2b_relu);
		std::string name_130 = "../features/ResNet101/res4b10_branch2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_130, res4b10_branch2c);
		std::string name_131 = "../features/ResNet101/res4b10_" + std::to_string(i) + ".csv";
		write_to_csv(name_131, res4b10);
		std::string name_132 = "../features/ResNet101/res4b10_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_132, res4b10_relu);
		std::string name_133 = "../features/ResNet101/res4b11_branch2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_133, res4b11_branch2a);
		std::string name_134 = "../features/ResNet101/res4b11_branch2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_134, res4b11_branch2a_relu);
		std::string name_135 = "../features/ResNet101/res4b11_branch2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_135, res4b11_branch2b);
		std::string name_136 = "../features/ResNet101/res4b11_branch2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_136, res4b11_branch2b_relu);
		std::string name_137 = "../features/ResNet101/res4b11_branch2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_137, res4b11_branch2c);
		std::string name_138 = "../features/ResNet101/res4b11_" + std::to_string(i) + ".csv";
		write_to_csv(name_138, res4b11);
		std::string name_139 = "../features/ResNet101/res4b11_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_139, res4b11_relu);
		std::string name_140 = "../features/ResNet101/res4b12_branch2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_140, res4b12_branch2a);
		std::string name_141 = "../features/ResNet101/res4b12_branch2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_141, res4b12_branch2a_relu);
		std::string name_142 = "../features/ResNet101/res4b12_branch2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_142, res4b12_branch2b);
		std::string name_143 = "../features/ResNet101/res4b12_branch2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_143, res4b12_branch2b_relu);
		std::string name_144 = "../features/ResNet101/res4b12_branch2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_144, res4b12_branch2c);
		std::string name_145 = "../features/ResNet101/res4b12_" + std::to_string(i) + ".csv";
		write_to_csv(name_145, res4b12);
		std::string name_146 = "../features/ResNet101/res4b12_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_146, res4b12_relu);
		std::string name_147 = "../features/ResNet101/res4b13_branch2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_147, res4b13_branch2a);
		std::string name_148 = "../features/ResNet101/res4b13_branch2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_148, res4b13_branch2a_relu);
		std::string name_149 = "../features/ResNet101/res4b13_branch2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_149, res4b13_branch2b);
		std::string name_150 = "../features/ResNet101/res4b13_branch2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_150, res4b13_branch2b_relu);
		std::string name_151 = "../features/ResNet101/res4b13_branch2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_151, res4b13_branch2c);
		std::string name_152 = "../features/ResNet101/res4b13_" + std::to_string(i) + ".csv";
		write_to_csv(name_152, res4b13);
		std::string name_153 = "../features/ResNet101/res4b13_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_153, res4b13_relu);
		std::string name_154 = "../features/ResNet101/res4b14_branch2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_154, res4b14_branch2a);
		std::string name_155 = "../features/ResNet101/res4b14_branch2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_155, res4b14_branch2a_relu);
		std::string name_156 = "../features/ResNet101/res4b14_branch2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_156, res4b14_branch2b);
		std::string name_157 = "../features/ResNet101/res4b14_branch2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_157, res4b14_branch2b_relu);
		std::string name_158 = "../features/ResNet101/res4b14_branch2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_158, res4b14_branch2c);
		std::string name_159 = "../features/ResNet101/res4b14_" + std::to_string(i) + ".csv";
		write_to_csv(name_159, res4b14);
		std::string name_160 = "../features/ResNet101/res4b14_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_160, res4b14_relu);
		std::string name_161 = "../features/ResNet101/res4b15_branch2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_161, res4b15_branch2a);
		std::string name_162 = "../features/ResNet101/res4b15_branch2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_162, res4b15_branch2a_relu);
		std::string name_163 = "../features/ResNet101/res4b15_branch2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_163, res4b15_branch2b);
		std::string name_164 = "../features/ResNet101/res4b15_branch2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_164, res4b15_branch2b_relu);
		std::string name_165 = "../features/ResNet101/res4b15_branch2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_165, res4b15_branch2c);
		std::string name_166 = "../features/ResNet101/res4b15_" + std::to_string(i) + ".csv";
		write_to_csv(name_166, res4b15);
		std::string name_167 = "../features/ResNet101/res4b15_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_167, res4b15_relu);
		std::string name_168 = "../features/ResNet101/res4b16_branch2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_168, res4b16_branch2a);
		std::string name_169 = "../features/ResNet101/res4b16_branch2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_169, res4b16_branch2a_relu);
		std::string name_170 = "../features/ResNet101/res4b16_branch2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_170, res4b16_branch2b);
		std::string name_171 = "../features/ResNet101/res4b16_branch2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_171, res4b16_branch2b_relu);
		std::string name_172 = "../features/ResNet101/res4b16_branch2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_172, res4b16_branch2c);
		std::string name_173 = "../features/ResNet101/res4b16_" + std::to_string(i) + ".csv";
		write_to_csv(name_173, res4b16);
		std::string name_174 = "../features/ResNet101/res4b16_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_174, res4b16_relu);
		std::string name_175 = "../features/ResNet101/res4b17_branch2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_175, res4b17_branch2a);
		std::string name_176 = "../features/ResNet101/res4b17_branch2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_176, res4b17_branch2a_relu);
		std::string name_177 = "../features/ResNet101/res4b17_branch2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_177, res4b17_branch2b);
		std::string name_178 = "../features/ResNet101/res4b17_branch2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_178, res4b17_branch2b_relu);
		std::string name_179 = "../features/ResNet101/res4b17_branch2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_179, res4b17_branch2c);
		std::string name_180 = "../features/ResNet101/res4b17_" + std::to_string(i) + ".csv";
		write_to_csv(name_180, res4b17);
		std::string name_181 = "../features/ResNet101/res4b17_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_181, res4b17_relu);
		std::string name_182 = "../features/ResNet101/res4b18_branch2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_182, res4b18_branch2a);
		std::string name_183 = "../features/ResNet101/res4b18_branch2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_183, res4b18_branch2a_relu);
		std::string name_184 = "../features/ResNet101/res4b18_branch2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_184, res4b18_branch2b);
		std::string name_185 = "../features/ResNet101/res4b18_branch2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_185, res4b18_branch2b_relu);
		std::string name_186 = "../features/ResNet101/res4b18_branch2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_186, res4b18_branch2c);
		std::string name_187 = "../features/ResNet101/res4b18_" + std::to_string(i) + ".csv";
		write_to_csv(name_187, res4b18);
		std::string name_188 = "../features/ResNet101/res4b18_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_188, res4b18_relu);
		std::string name_189 = "../features/ResNet101/res4b19_branch2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_189, res4b19_branch2a);
		std::string name_190 = "../features/ResNet101/res4b19_branch2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_190, res4b19_branch2a_relu);
		std::string name_191 = "../features/ResNet101/res4b19_branch2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_191, res4b19_branch2b);
		std::string name_192 = "../features/ResNet101/res4b19_branch2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_192, res4b19_branch2b_relu);
		std::string name_193 = "../features/ResNet101/res4b19_branch2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_193, res4b19_branch2c);
		std::string name_194 = "../features/ResNet101/res4b19_" + std::to_string(i) + ".csv";
		write_to_csv(name_194, res4b19);
		std::string name_195 = "../features/ResNet101/res4b19_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_195, res4b19_relu);
		std::string name_196 = "../features/ResNet101/res4b20_branch2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_196, res4b20_branch2a);
		std::string name_197 = "../features/ResNet101/res4b20_branch2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_197, res4b20_branch2a_relu);
		std::string name_198 = "../features/ResNet101/res4b20_branch2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_198, res4b20_branch2b);
		std::string name_199 = "../features/ResNet101/res4b20_branch2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_199, res4b20_branch2b_relu);
		std::string name_200 = "../features/ResNet101/res4b20_branch2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_200, res4b20_branch2c);
		std::string name_201 = "../features/ResNet101/res4b20_" + std::to_string(i) + ".csv";
		write_to_csv(name_201, res4b20);
		std::string name_202 = "../features/ResNet101/res4b20_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_202, res4b20_relu);
		std::string name_203 = "../features/ResNet101/res4b21_branch2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_203, res4b21_branch2a);
		std::string name_204 = "../features/ResNet101/res4b21_branch2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_204, res4b21_branch2a_relu);
		std::string name_205 = "../features/ResNet101/res4b21_branch2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_205, res4b21_branch2b);
		std::string name_206 = "../features/ResNet101/res4b21_branch2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_206, res4b21_branch2b_relu);
		std::string name_207 = "../features/ResNet101/res4b21_branch2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_207, res4b21_branch2c);
		std::string name_208 = "../features/ResNet101/res4b21_" + std::to_string(i) + ".csv";
		write_to_csv(name_208, res4b21);
		std::string name_209 = "../features/ResNet101/res4b21_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_209, res4b21_relu);
		std::string name_210 = "../features/ResNet101/res4b22_branch2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_210, res4b22_branch2a);
		std::string name_211 = "../features/ResNet101/res4b22_branch2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_211, res4b22_branch2a_relu);
		std::string name_212 = "../features/ResNet101/res4b22_branch2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_212, res4b22_branch2b);
		std::string name_213 = "../features/ResNet101/res4b22_branch2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_213, res4b22_branch2b_relu);
		std::string name_214 = "../features/ResNet101/res4b22_branch2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_214, res4b22_branch2c);
		std::string name_215 = "../features/ResNet101/res4b22_" + std::to_string(i) + ".csv";
		write_to_csv(name_215, res4b22);
		std::string name_216 = "../features/ResNet101/res4b22_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_216, res4b22_relu);
		std::string name_217 = "../features/ResNet101/res5a_branch1_" + std::to_string(i) + ".csv";
		write_to_csv(name_217, res5a_branch1);
		std::string name_218 = "../features/ResNet101/res5a_branch2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_218, res5a_branch2a);
		std::string name_219 = "../features/ResNet101/res5a_branch2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_219, res5a_branch2a_relu);
		std::string name_220 = "../features/ResNet101/res5a_branch2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_220, res5a_branch2b);
		std::string name_221 = "../features/ResNet101/res5a_branch2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_221, res5a_branch2b_relu);
		std::string name_222 = "../features/ResNet101/res5a_branch2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_222, res5a_branch2c);
		std::string name_223 = "../features/ResNet101/res5a_" + std::to_string(i) + ".csv";
		write_to_csv(name_223, res5a);
		std::string name_224 = "../features/ResNet101/res5a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_224, res5a_relu);
		std::string name_225 = "../features/ResNet101/res5b_branch2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_225, res5b_branch2a);
		std::string name_226 = "../features/ResNet101/res5b_branch2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_226, res5b_branch2a_relu);
		std::string name_227 = "../features/ResNet101/res5b_branch2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_227, res5b_branch2b);
		std::string name_228 = "../features/ResNet101/res5b_branch2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_228, res5b_branch2b_relu);
		std::string name_229 = "../features/ResNet101/res5b_branch2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_229, res5b_branch2c);
		std::string name_230 = "../features/ResNet101/res5b_" + std::to_string(i) + ".csv";
		write_to_csv(name_230, res5b);
		std::string name_231 = "../features/ResNet101/res5b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_231, res5b_relu);
		std::string name_232 = "../features/ResNet101/res5c_branch2a_" + std::to_string(i) + ".csv";
		write_to_csv(name_232, res5c_branch2a);
		std::string name_233 = "../features/ResNet101/res5c_branch2a_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_233, res5c_branch2a_relu);
		std::string name_234 = "../features/ResNet101/res5c_branch2b_" + std::to_string(i) + ".csv";
		write_to_csv(name_234, res5c_branch2b);
		std::string name_235 = "../features/ResNet101/res5c_branch2b_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_235, res5c_branch2b_relu);
		std::string name_236 = "../features/ResNet101/res5c_branch2c_" + std::to_string(i) + ".csv";
		write_to_csv(name_236, res5c_branch2c);
		std::string name_237 = "../features/ResNet101/res5c_" + std::to_string(i) + ".csv";
		write_to_csv(name_237, res5c);
		std::string name_238 = "../features/ResNet101/res5c_relu_" + std::to_string(i) + ".csv";
		write_to_csv(name_238, res5c_relu);
		std::string name_239 = "../features/ResNet101/pool5_" + std::to_string(i) + ".csv";
		write_to_csv(name_239, pool5);
		std::string name_240 = "../features/ResNet101/fc1000_" + std::to_string(i) + ".csv";
		write_to_csv(name_240, fc1000);
    }
