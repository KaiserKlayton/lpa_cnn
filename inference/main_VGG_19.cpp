...
int main(int argc, char *argv[])
{
	...
	MatrixXd conv1_1_weights = load_csv_arma<MatrixXd>("../weights/VGG_19/conv1_1_weights.csv");
	...
	MatrixXd conv1_1_result_params = load_csv_arma<MatrixXd>("../features/VGG_19/caffe/result_params.csv");
	const float conv1_1_result_min = conv1_1_result_params(0, 0);
	const float conv1_1_result_max = conv1_1_result_params(0, 1);
	
	MatrixXd conv1_1_biases = load_csv_arma<MatrixXd>("../weights/VGG_19/conv1_1_biases.csv");
	...
	MatrixXd conv1_2_weights = load_csv_arma<MatrixXd>("../weights/VGG_19/conv1_2_weights.csv");
	MatrixXd conv1_2_w = conv1_2_weights;
	const float conv1_2_min = conv1_2_w.minCoeff();
	const float conv1_2_max = conv1_2_w.maxCoeff();
	
	MatrixXd conv1_2_result_params = load_csv_arma<MatrixXd>("../features/VGG_19/caffe/result_params.csv");
	const float conv1_2_result_min = conv1_2_result_params(1, 0);
	const float conv1_2_result_max = conv1_2_result_params(1, 1);
	
	MatrixXd conv1_2_biases = load_csv_arma<MatrixXd>("../weights/VGG_19/conv1_2_biases.csv");
	...
	MatrixXd conv2_1_weights = load_csv_arma<MatrixXd>("../weights/VGG_19/conv2_1_weights.csv");
	MatrixXd conv2_1_w = conv2_1_weights;
	const float conv2_1_min = conv2_1_w.minCoeff();
	const float conv2_1_max = conv2_1_w.maxCoeff();
	
	MatrixXd conv2_1_result_params = load_csv_arma<MatrixXd>("../features/VGG_19/caffe/result_params.csv");
	const float conv2_1_result_min = conv2_1_result_params(2, 0);
	const float conv2_1_result_max = conv2_1_result_params(2, 1);
	
	MatrixXd conv2_1_biases = load_csv_arma<MatrixXd>("../weights/VGG_19/conv2_1_biases.csv");
	...
	MatrixXd conv2_2_weights = load_csv_arma<MatrixXd>("../weights/VGG_19/conv2_2_weights.csv");
	MatrixXd conv2_2_w = conv2_2_weights;
	const float conv2_2_min = conv2_2_w.minCoeff();
	const float conv2_2_max = conv2_2_w.maxCoeff();
	
	MatrixXd conv2_2_result_params = load_csv_arma<MatrixXd>("../features/VGG_19/caffe/result_params.csv");
	const float conv2_2_result_min = conv2_2_result_params(3, 0);
	const float conv2_2_result_max = conv2_2_result_params(3, 1);
	
	MatrixXd conv2_2_biases = load_csv_arma<MatrixXd>("../weights/VGG_19/conv2_2_biases.csv");
	...
	MatrixXd conv3_1_weights = load_csv_arma<MatrixXd>("../weights/VGG_19/conv3_1_weights.csv");
	MatrixXd conv3_1_w = conv3_1_weights;
	const float conv3_1_min = conv3_1_w.minCoeff();
	const float conv3_1_max = conv3_1_w.maxCoeff();
	
	MatrixXd conv3_1_result_params = load_csv_arma<MatrixXd>("../features/VGG_19/caffe/result_params.csv");
	const float conv3_1_result_min = conv3_1_result_params(4, 0);
	const float conv3_1_result_max = conv3_1_result_params(4, 1);
	
	MatrixXd conv3_1_biases = load_csv_arma<MatrixXd>("../weights/VGG_19/conv3_1_biases.csv");
	...
	MatrixXd conv3_2_weights = load_csv_arma<MatrixXd>("../weights/VGG_19/conv3_2_weights.csv");
	MatrixXd conv3_2_w = conv3_2_weights;
	const float conv3_2_min = conv3_2_w.minCoeff();
	const float conv3_2_max = conv3_2_w.maxCoeff();
	
	MatrixXd conv3_2_result_params = load_csv_arma<MatrixXd>("../features/VGG_19/caffe/result_params.csv");
	const float conv3_2_result_min = conv3_2_result_params(5, 0);
	const float conv3_2_result_max = conv3_2_result_params(5, 1);
	
	MatrixXd conv3_2_biases = load_csv_arma<MatrixXd>("../weights/VGG_19/conv3_2_biases.csv");
	...
	MatrixXd conv3_3_weights = load_csv_arma<MatrixXd>("../weights/VGG_19/conv3_3_weights.csv");
	MatrixXd conv3_3_w = conv3_3_weights;
	const float conv3_3_min = conv3_3_w.minCoeff();
	const float conv3_3_max = conv3_3_w.maxCoeff();
	
	MatrixXd conv3_3_result_params = load_csv_arma<MatrixXd>("../features/VGG_19/caffe/result_params.csv");
	const float conv3_3_result_min = conv3_3_result_params(6, 0);
	const float conv3_3_result_max = conv3_3_result_params(6, 1);
	
	MatrixXd conv3_3_biases = load_csv_arma<MatrixXd>("../weights/VGG_19/conv3_3_biases.csv");
	...
	MatrixXd conv3_4_weights = load_csv_arma<MatrixXd>("../weights/VGG_19/conv3_4_weights.csv");
	MatrixXd conv3_4_w = conv3_4_weights;
	const float conv3_4_min = conv3_4_w.minCoeff();
	const float conv3_4_max = conv3_4_w.maxCoeff();
	
	MatrixXd conv3_4_result_params = load_csv_arma<MatrixXd>("../features/VGG_19/caffe/result_params.csv");
	const float conv3_4_result_min = conv3_4_result_params(7, 0);
	const float conv3_4_result_max = conv3_4_result_params(7, 1);
	
	MatrixXd conv3_4_biases = load_csv_arma<MatrixXd>("../weights/VGG_19/conv3_4_biases.csv");
	VectorXd conv3_4_b(Map<VectorXd>(conv3_4_biases.data(), conv3_4_biases.cols()*conv3_4_biases.rows()));
	...
	const int im_height_9 = static_cast<int>(ceil(static_cast<float>(output_height_8 + 2 * pp1_3 - f_3 ) / s_3)) + 1;
	const int im_width_9 = static_cast<int>(ceil(static_cast<float>(output_width_8 + 2 * pp2_3 - f_3) / s_3)) + 1;
	...
	MatrixXd conv4_1_weights = load_csv_arma<MatrixXd>("../weights/VGG_19/conv4_1_weights.csv");
	MatrixXd conv4_1_w = conv4_1_weights;
	const float conv4_1_min = conv4_1_w.minCoeff();
	const float conv4_1_max = conv4_1_w.maxCoeff();
	
	MatrixXd conv4_1_result_params = load_csv_arma<MatrixXd>("../features/VGG_19/caffe/result_params.csv");
	const float conv4_1_result_min = conv4_1_result_params(8, 0);
	const float conv4_1_result_max = conv4_1_result_params(8, 1);
	
	MatrixXd conv4_1_biases = load_csv_arma<MatrixXd>("../weights/VGG_19/conv4_1_biases.csv");
	...
	MatrixXd conv4_2_weights = load_csv_arma<MatrixXd>("../weights/VGG_19/conv4_2_weights.csv");
	MatrixXd conv4_2_w = conv4_2_weights;
	const float conv4_2_min = conv4_2_w.minCoeff();
	const float conv4_2_max = conv4_2_w.maxCoeff();
	
	MatrixXd conv4_2_result_params = load_csv_arma<MatrixXd>("../features/VGG_19/caffe/result_params.csv");
	const float conv4_2_result_min = conv4_2_result_params(9, 0);
	const float conv4_2_result_max = conv4_2_result_params(9, 1);
	
	MatrixXd conv4_2_biases = load_csv_arma<MatrixXd>("../weights/VGG_19/conv4_2_biases.csv");
	...
	MatrixXd conv4_3_weights = load_csv_arma<MatrixXd>("../weights/VGG_19/conv4_3_weights.csv");
	MatrixXd conv4_3_w = conv4_3_weights;
	const float conv4_3_min = conv4_3_w.minCoeff();
	const float conv4_3_max = conv4_3_w.maxCoeff();
	
	MatrixXd conv4_3_result_params = load_csv_arma<MatrixXd>("../features/VGG_19/caffe/result_params.csv");
	const float conv4_3_result_min = conv4_3_result_params(10, 0);
	const float conv4_3_result_max = conv4_3_result_params(10, 1);
	
	MatrixXd conv4_3_biases = load_csv_arma<MatrixXd>("../weights/VGG_19/conv4_3_biases.csv");
	...
	MatrixXd conv4_4_weights = load_csv_arma<MatrixXd>("../weights/VGG_19/conv4_4_weights.csv");
	MatrixXd conv4_4_w = conv4_4_weights;
	const float conv4_4_min = conv4_4_w.minCoeff();
	const float conv4_4_max = conv4_4_w.maxCoeff();
	
	MatrixXd conv4_4_result_params = load_csv_arma<MatrixXd>("../features/VGG_19/caffe/result_params.csv");
	const float conv4_4_result_min = conv4_4_result_params(11, 0);
	const float conv4_4_result_max = conv4_4_result_params(11, 1);
	
	MatrixXd conv4_4_biases = load_csv_arma<MatrixXd>("../weights/VGG_19/conv4_4_biases.csv");
	VectorXd conv4_4_b(Map<VectorXd>(conv4_4_biases.data(), conv4_4_biases.cols()*conv4_4_biases.rows()));
	
	const int f_4 = 2;
	const int s_4 = 2;
	std::string mode_4 = "max";
	
	const int pp1_4 = 0;
	const int pp2_4 = 0;
	
	const int im_height_13 = static_cast<int>(ceil(static_cast<float>(output_height_12 + 2 * pp1_4 - f_4 ) / s_4)) + 1;
	const int im_width_13 = static_cast<int>(ceil(static_cast<float>(output_width_12 + 2 * pp2_4 - f_4) / s_4)) + 1;
	...
	MatrixXd conv5_1_weights = load_csv_arma<MatrixXd>("../weights/VGG_19/conv5_1_weights.csv");
	MatrixXd conv5_1_w = conv5_1_weights;
	const float conv5_1_min = conv5_1_w.minCoeff();
	const float conv5_1_max = conv5_1_w.maxCoeff();
	
	MatrixXd conv5_1_result_params = load_csv_arma<MatrixXd>("../features/VGG_19/caffe/result_params.csv");
	const float conv5_1_result_min = conv5_1_result_params(12, 0);
	const float conv5_1_result_max = conv5_1_result_params(12, 1);
	
	MatrixXd conv5_1_biases = load_csv_arma<MatrixXd>("../weights/VGG_19/conv5_1_biases.csv");
	...
	MatrixXd conv5_2_weights = load_csv_arma<MatrixXd>("../weights/VGG_19/conv5_2_weights.csv");
	MatrixXd conv5_2_w = conv5_2_weights;
	const float conv5_2_min = conv5_2_w.minCoeff();
	const float conv5_2_max = conv5_2_w.maxCoeff();
	
	MatrixXd conv5_2_result_params = load_csv_arma<MatrixXd>("../features/VGG_19/caffe/result_params.csv");
	const float conv5_2_result_min = conv5_2_result_params(13, 0);
	const float conv5_2_result_max = conv5_2_result_params(13, 1);
	
	MatrixXd conv5_2_biases = load_csv_arma<MatrixXd>("../weights/VGG_19/conv5_2_biases.csv");
	...
	MatrixXd conv5_3_weights = load_csv_arma<MatrixXd>("../weights/VGG_19/conv5_3_weights.csv");
	MatrixXd conv5_3_w = conv5_3_weights;
	const float conv5_3_min = conv5_3_w.minCoeff();
	const float conv5_3_max = conv5_3_w.maxCoeff();
	
	MatrixXd conv5_3_result_params = load_csv_arma<MatrixXd>("../features/VGG_19/caffe/result_params.csv");
	const float conv5_3_result_min = conv5_3_result_params(14, 0);
	const float conv5_3_result_max = conv5_3_result_params(14, 1);
	
	MatrixXd conv5_3_biases = load_csv_arma<MatrixXd>("../weights/VGG_19/conv5_3_biases.csv");
	...
	const int k_num_16 = 512;
	const int k_size_16 = 9;
	...
	MatrixXd conv5_4_weights = load_csv_arma<MatrixXd>("../weights/VGG_19/conv5_4_weights.csv");
	MatrixXd conv5_4_w = conv5_4_weights;
	const float conv5_4_min = conv5_4_w.minCoeff();
	const float conv5_4_max = conv5_4_w.maxCoeff();
	
	MatrixXd conv5_4_result_params = load_csv_arma<MatrixXd>("../features/VGG_19/caffe/result_params.csv");
	const float conv5_4_result_min = conv5_4_result_params(15, 0);
	const float conv5_4_result_max = conv5_4_result_params(15, 1);
	
	MatrixXd conv5_4_biases = load_csv_arma<MatrixXd>("../weights/VGG_19/conv5_4_biases.csv");
	VectorXd conv5_4_b(Map<VectorXd>(conv5_4_biases.data(), conv5_4_biases.cols()*conv5_4_biases.rows()));
	
	const int f_5 = 2;
	const int s_5 = 2;
	std::string mode_5 = "max";
	
	const int pp1_5 = 0;
	const int pp2_5 = 0;
	
	MatrixXd fc6_weights = load_csv_arma<MatrixXd>("../weights/VGG_19/fc6_weights.csv");
	
	MatrixXd fc6_biases = load_csv_arma<MatrixXd>("../weights/VGG_19/fc6_biases.csv");
	VectorXd fc6_b(Map<VectorXd>(fc6_biases.data(), fc6_biases.cols()*fc6_biases.rows()));
	
	MatrixXd fc7_weights = load_csv_arma<MatrixXd>("../weights/VGG_19/fc7_weights.csv");
	
	MatrixXd fc7_biases = load_csv_arma<MatrixXd>("../weights/VGG_19/fc7_biases.csv");
	VectorXd fc7_b(Map<VectorXd>(fc7_biases.data(), fc7_biases.cols()*fc7_biases.rows()));
	
	MatrixXd fc8_weights = load_csv_arma<MatrixXd>("../weights/VGG_19/fc8_weights.csv");
	
	MatrixXd fc8_biases = load_csv_arma<MatrixXd>("../weights/VGG_19/fc8_biases.csv");
    ...
    for(int i=0; i < im_num; ++i)
    {
		...
		std::tie(conv1_1, gemm_time_1, offline_time_1) = convolve(image, im_size_1, im_height_1, im_width_1, im_depth_1, k_size_1, stride_1, conv1_1_b, p1_1, p2_1, conv1_1_w, output_size_1, mode, conv1_1_min, conv1_1_max, conv1_1_result_min, conv1_1_result_max);
		...
		std::tie(conv1_2, gemm_time_2, offline_time_2) = convolve(relu1_1, im_size_2, im_height_2, im_width_2, im_depth_2, k_size_2, stride_2, conv1_2_b, p1_2, p2_2, conv1_2_w, output_size_2, mode, conv1_2_min, conv1_2_max, conv1_2_result_min, conv1_2_result_max);
		...
		std::tie(conv2_1, gemm_time_3, offline_time_3) = convolve(pool1, im_size_3, im_height_3, im_width_3, im_depth_3, k_size_3, stride_3, conv2_1_b, p1_3, p2_3, conv2_1_w, output_size_3, mode, conv2_1_min, conv2_1_max, conv2_1_result_min, conv2_1_result_max);
		...
		std::tie(conv2_2, gemm_time_4, offline_time_4) = convolve(relu2_1, im_size_4, im_height_4, im_width_4, im_depth_4, k_size_4, stride_4, conv2_2_b, p1_4, p2_4, conv2_2_w, output_size_4, mode, conv2_2_min, conv2_2_max, conv2_2_result_min, conv2_2_result_max);
		...
		std::tie(conv3_1, gemm_time_5, offline_time_5) = convolve(pool2, im_size_5, im_height_5, im_width_5, im_depth_5, k_size_5, stride_5, conv3_1_b, p1_5, p2_5, conv3_1_w, output_size_5, mode, conv3_1_min, conv3_1_max, conv3_1_result_min, conv3_1_result_max);
		...
		std::tie(conv3_2, gemm_time_6, offline_time_6) = convolve(relu3_1, im_size_6, im_height_6, im_width_6, im_depth_6, k_size_6, stride_6, conv3_2_b, p1_6, p2_6, conv3_2_w, output_size_6, mode, conv3_2_min, conv3_2_max, conv3_2_result_min, conv3_2_result_max);
		...
		std::tie(conv3_3, gemm_time_7, offline_time_7) = convolve(relu3_2, im_size_7, im_height_7, im_width_7, im_depth_7, k_size_7, stride_7, conv3_3_b, p1_7, p2_7, conv3_3_w, output_size_7, mode, conv3_3_min, conv3_3_max, conv3_3_result_min, conv3_3_result_max);
		...
		std::tie(conv3_4, gemm_time_8, offline_time_8) = convolve(relu3_3, im_size_8, im_height_8, im_width_8, im_depth_8, k_size_8, stride_8, conv3_4_b, p1_8, p2_8, conv3_4_w, output_size_8, mode, conv3_4_min, conv3_4_max, conv3_4_result_min, conv3_4_result_max);
		
		MatrixXd relu3_4 = relu(conv3_4);
		
		MatrixXd pool3 = pool(relu3_4, f_3, s_3, output_width_8, output_height_8, pp1_3, pp2_3, mode_3);
		
		MatrixXd conv4_1;
		float gemm_time_9;
		float offline_time_9;
		std::tie(conv4_1, gemm_time_9, offline_time_9) = convolve(pool3, im_size_9, im_height_9, im_width_9, im_depth_9, k_size_9, stride_9, conv4_1_b, p1_9, p2_9, conv4_1_w, output_size_9, mode, conv4_1_min, conv4_1_max, conv4_1_result_min, conv4_1_result_max);
		...
		std::tie(conv4_2, gemm_time_10, offline_time_10) = convolve(relu4_1, im_size_10, im_height_10, im_width_10, im_depth_10, k_size_10, stride_10, conv4_2_b, p1_10, p2_10, conv4_2_w, output_size_10, mode, conv4_2_min, conv4_2_max, conv4_2_result_min, conv4_2_result_max);
		...
		std::tie(conv4_3, gemm_time_11, offline_time_11) = convolve(relu4_2, im_size_11, im_height_11, im_width_11, im_depth_11, k_size_11, stride_11, conv4_3_b, p1_11, p2_11, conv4_3_w, output_size_11, mode, conv4_3_min, conv4_3_max, conv4_3_result_min, conv4_3_result_max);
		...
		std::tie(conv4_4, gemm_time_12, offline_time_12) = convolve(relu4_3, im_size_12, im_height_12, im_width_12, im_depth_12, k_size_12, stride_12, conv4_4_b, p1_12, p2_12, conv4_4_w, output_size_12, mode, conv4_4_min, conv4_4_max, conv4_4_result_min, conv4_4_result_max);
		
		MatrixXd relu4_4 = relu(conv4_4);
		
		MatrixXd pool4 = pool(relu4_4, f_4, s_4, output_width_12, output_height_12, pp1_4, pp2_4, mode_4);
		
		MatrixXd conv5_1;
		float gemm_time_13;
		float offline_time_13;
		std::tie(conv5_1, gemm_time_13, offline_time_13) = convolve(pool4, im_size_13, im_height_13, im_width_13, im_depth_13, k_size_13, stride_13, conv5_1_b, p1_13, p2_13, conv5_1_w, output_size_13, mode, conv5_1_min, conv5_1_max, conv5_1_result_min, conv5_1_result_max);
		...
		std::tie(conv5_2, gemm_time_14, offline_time_14) = convolve(relu5_1, im_size_14, im_height_14, im_width_14, im_depth_14, k_size_14, stride_14, conv5_2_b, p1_14, p2_14, conv5_2_w, output_size_14, mode, conv5_2_min, conv5_2_max, conv5_2_result_min, conv5_2_result_max);
		...
		std::tie(conv5_3, gemm_time_15, offline_time_15) = convolve(relu5_2, im_size_15, im_height_15, im_width_15, im_depth_15, k_size_15, stride_15, conv5_3_b, p1_15, p2_15, conv5_3_w, output_size_15, mode, conv5_3_min, conv5_3_max, conv5_3_result_min, conv5_3_result_max);
		...
		std::tie(conv5_4, gemm_time_16, offline_time_16) = convolve(relu5_3, im_size_16, im_height_16, im_width_16, im_depth_16, k_size_16, stride_16, conv5_4_b, p1_16, p2_16, conv5_4_w, output_size_16, mode, conv5_4_min, conv5_4_max, conv5_4_result_min, conv5_4_result_max);
		
		MatrixXd relu5_4 = relu(conv5_4);
		
		MatrixXd pool5 = pool(relu5_4, f_5, s_5, output_width_16, output_height_16, pp1_5, pp2_5, mode_5);
