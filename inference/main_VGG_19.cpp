...
int main(int argc, char *argv[])
{
    ...
    for(int i=0; i < im_num; ++i)
    {
		...
		std::tie(conv3_4, gemm_time_8, offline_time_8) = convolve(relu3_3, im_size_8, im_height_8, im_width_8, im_depth_8, k_size_8, stride_8, conv3_4_b, p1_8, p2_8, conv3_4_w, output_size_8, mode, conv3_4_min, conv3_4_max, input_min, input_max, conv3_4_result_min, conv3_4_result_max);
		...
		std::tie(conv4_1, gemm_time_9, offline_time_9) = convolve(pool3, im_size_9, im_height_9, im_width_9, im_depth_9, k_size_9, stride_9, conv4_1_b, p1_9, p2_9, conv4_1_w, output_size_9, mode, conv4_1_min, conv4_1_max, input_min, input_max, conv4_1_result_min, conv4_1_result_max);
		...
		std::tie(conv4_2, gemm_time_10, offline_time_10) = convolve(relu4_1, im_size_10, im_height_10, im_width_10, im_depth_10, k_size_10, stride_10, conv4_2_b, p1_10, p2_10, conv4_2_w, output_size_10, mode, conv4_2_min, conv4_2_max, input_min, input_max, conv4_2_result_min, conv4_2_result_max);
		...
		std::tie(conv4_3, gemm_time_11, offline_time_11) = convolve(relu4_2, im_size_11, im_height_11, im_width_11, im_depth_11, k_size_11, stride_11, conv4_3_b, p1_11, p2_11, conv4_3_w, output_size_11, mode, conv4_3_min, conv4_3_max, input_min, input_max, conv4_3_result_min, conv4_3_result_max);
		...
		std::tie(conv4_4, gemm_time_12, offline_time_12) = convolve(relu4_3, im_size_12, im_height_12, im_width_12, im_depth_12, k_size_12, stride_12, conv4_4_b, p1_12, p2_12, conv4_4_w, output_size_12, mode, conv4_4_min, conv4_4_max, input_min, input_max, conv4_4_result_min, conv4_4_result_max);
		...
		std::tie(conv5_1, gemm_time_13, offline_time_13) = convolve(pool4, im_size_13, im_height_13, im_width_13, im_depth_13, k_size_13, stride_13, conv5_1_b, p1_13, p2_13, conv5_1_w, output_size_13, mode, conv5_1_min, conv5_1_max, input_min, input_max, conv5_1_result_min, conv5_1_result_max);
		...
		std::tie(conv5_2, gemm_time_14, offline_time_14) = convolve(relu5_1, im_size_14, im_height_14, im_width_14, im_depth_14, k_size_14, stride_14, conv5_2_b, p1_14, p2_14, conv5_2_w, output_size_14, mode, conv5_2_min, conv5_2_max, input_min, input_max, conv5_2_result_min, conv5_2_result_max);
		...
		std::tie(conv5_3, gemm_time_15, offline_time_15) = convolve(relu5_2, im_size_15, im_height_15, im_width_15, im_depth_15, k_size_15, stride_15, conv5_3_b, p1_15, p2_15, conv5_3_w, output_size_15, mode, conv5_3_min, conv5_3_max, input_min, input_max, conv5_3_result_min, conv5_3_result_max);
		...
		std::tie(conv5_4, gemm_time_16, offline_time_16) = convolve(relu5_3, im_size_16, im_height_16, im_width_16, im_depth_16, k_size_16, stride_16, conv5_4_b, p1_16, p2_16, conv5_4_w, output_size_16, mode, conv5_4_min, conv5_4_max, input_min, input_max, conv5_4_result_min, conv5_4_result_max);
